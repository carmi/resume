...
\section{\textsc{Technical \\ Skills}}
    {\sl Toolbox}: Ruby, Rails, Django, Python, Rackspace, AWS, git, Agile, devops, \LaTeX \\

\section{\textsc{Experience}}
    {\sl Founder and Senior Software Engineer} \hfill 2015 - Present \\ CarmiMedia, LLC
    \begin{itemize}  \itemsep -2pt %reduce space between items
        \item Founded and led a web development consultancy focusing on great software and design: http://carmimedia.com
    \end{itemize}
