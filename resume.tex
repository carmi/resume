...
\begin{resume}
\section{\textsc{Summary}} I combine deep technical skills with high-level problem solving to find solutions to business problems.
...
\section{\textsc{Experience}}
    ...
    \begin{itemize}  \itemsep -2pt %reduce space between items
        \item Founded and led a consultancy bridging technology and business: http://carmimedia.com
    \end{itemize}
