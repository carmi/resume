...
\address{{\bf Location:} Portland, OR / New York City}
...
\section{\textsc{Technical \\ Skills}}
    {\sl Toolbox}: Rails, Django, Flask, AWS, git, devops, \LaTeX \\

\section{\textsc{Experience}}
    {\sl Software Engineer} \hfill 2013 - Present \\ Brewster
    \begin{itemize}  \itemsep -2pt %reduce space between items
        \item As a core developer of a small startup, designed and implemented features across web and mobile products.
    \end{itemize}
